...
//     // ========== GOLD COLLECTION (4 products) ==========
//     { id: 1, name: "18K Gold Necklace", price: "$2,450", category: "Gold", image: "assets/images/products/gold-necklace.jpg", desc: "Elegant 18K gold necklace with intricate design. Perfect for weddings and special occasions. Weight: 12g" },
//     { id: 2, name: "Gold Earrings", price: "$1,890", category: "Gold", image: "assets/images/products/gold-earrings.jpg", desc: "Stylish gold jhumkas with contemporary design. Weight: 6g" },
//     { id: 3, name: "Gold Bangle Set", price: "$3,800", category: "Gold", image: "assets/images/products/gold-bangles.jpg", desc: "Traditional gold bangles with intricate carving. Set of 4 bangles. Weight: 20g" },
//     { id: 4, name: "Gold Temple Necklace", price: "$8,900", category: "Gold", image: "assets/images/products/temple-necklace.jpg", desc: "Traditional South Indian temple necklace with intricate deity motifs. 22K pure gold. Weight: 45g" },
//     { id: 5, name: "Emerald Gold Ring", price: "$3,200", category: "Gold", image: "assets/images/products/emerald-ring.jpg", desc: "Stunning emerald stone set in 18K gold with diamond accents. Weight: 8g" },
//     { id: 6, name: "Gold Mangalsutra", price: "$4,500", category: "Gold", image: "assets/images/products/gold-mangalsutra.jpg", desc: "Traditional gold mangalsutra with black beads. Weight: 15g" },
//     { id: 7, name: "Gold Nose Pin", price: "$450", category: "Gold", image: "assets/images/products/gold-nose-pin.jpg", desc: "Delicate gold nose pin with cubic zirconia. Weight: 1.5g" },
//     { id: 8, name: "Gold Toe Rings", price: "$280", category: "Gold", image: "assets/images/products/gold-toe-rings.jpg", desc: "Set of 2 gold toe rings with floral design. Weight: 2g each" },

//     // ========== SILVER COLLECTION (4 products) ==========
//     { id: 9, name: "Silver Bracelet", price: "$320", category: "Silver", image: "assets/images/products/silver-bracelet.jpg", desc: "Sterling silver bracelet with antique finish. Lightweight and elegant. Weight: 15g" },
//     { id: 10, name: "Silver Anklets", price: "$180", category: "Silver", image: "assets/images/products/silver-anklets.jpg", desc: "Beautiful silver anklets with bell detailing. Weight: 25g" },
//     { id: 11, name: "Silver Necklace", price: "$550", category: "Silver", image: "assets/images/products/silver-necklace.jpg", desc: "Modern silver necklace with pendant. Perfect for daily wear. Weight: 18g" },
//     { id: 12, name: "Silver Earrings", price: "$150", category: "Silver", image: "assets/images/products/silver-earrings.jpg", desc: "Stylish silver drop earrings. Lightweight and trendy. Weight: 5g" },
//     { id: 13, name: "Silver Ring", price: "$95", category: "Silver", image: "assets/images/products/silver-ring.jpg", desc: "Adjustable silver ring with gemstone. Weight: 3g" },
//     { id: 14, name: "Silver Pendant", price: "$120", category: "Silver", image: "assets/images/products/silver-pendant.jpg", desc: "Lord Ganesha silver pendant on chain. Weight: 8g" },
//     { id: 15, name: "Silver Cufflinks", price: "$200", category: "Silver", image: "assets/images/products/silver-cufflinks.jpg", desc: "Classic silver cufflinks for men. Weight: 10g" },
//     { id: 16, name: "Silver Bangles", price: "$250", category: "Silver", image: "assets/images/products/silver-bangles.jpg", desc: "Set of 2 silver bangles with traditional design. Weight: 20g" },

//     // ========== DIAMOND COLLECTION (4 products) ==========
//     { id: 17, name: "Diamond Solitaire Ring", price: "$4,200", category: "Diamond", image: "assets/images/products/diamond-ring.jpg", desc: "Certified VS clarity diamond set in platinum. 0.5 carat center stone" },
//     { id: 18, name: "Diamond Pendant", price: "$3,150", category: "Diamond", image: "assets/images/products/diamond-pendant.jpg", desc: "Solitaire diamond pendant on 18K gold chain. 0.3 carat diamond" },
//     { id: 19, name: "Platinum Diamond Band", price: "$5,500", category: "Diamond", image: "assets/images/products/platinum-band.jpg", desc: "Platinum diamond band with 0.8 carat total weight. Perfect wedding band" },
//     { id: 20, name: "Diamond Earrings", price: "$2,800", category: "Diamond", image: "assets/images/products/diamond-earrings.jpg", desc: "Beautiful diamond stud earrings. Total weight: 0.6 carat" },
//     { id: 21, name: "Diamond Nose Pin", price: "$1,200", category: "Diamond", image: "assets/images/products/diamond-nose-pin.jpg", desc: "Single diamond nose pin on gold base. Diamond: 0.1 carat" },
//     { id: 22, name: "Diamond Bracelet", price: "$3,900", category: "Diamond", image: "assets/images/products/diamond-bracelet.jpg", desc: "Tennis diamond bracelet. Total diamond weight: 1.2 carat" },
//     { id: 23, name: "Diamond Necklace", price: "$12,500", category: "Diamond", image: "assets/images/products/diamond-necklace.jpg", desc: "Luxury diamond necklace with 3 carat total diamond weight" },
//     { id: 24, name: "Diamond Mangalsutra", price: "$6,800", category: "Diamond", image: "assets/images/products/diamond-mangalsutra.jpg", desc: "Modern diamond mangalsutra with 0.8 carat diamonds" },

//     // ========== BRIDAL COLLECTION (4 products) ==========
//     { id: 25, name: "Bridal Choker Set", price: "$6,750", category: "Bridal", image: "assets/images/products/bridal-choker.jpg", desc: "Traditional bridal choker set with uncut diamonds and gold. Includes matching earrings" },
//     { id: 26, name: "Bridal Matha Patti", price: "$2,800", category: "Bridal", image: "assets/images/products/matha-patti.jpg", desc: "Traditional bridal matha patti (headpiece) with kundan work and pearls" },
//     { id: 27, name: "Bridal Necklace Set", price: "$9,500", category: "Bridal", image: "assets/images/products/bridal-necklace-set.jpg", desc: "Complete bridal necklace set with earrings and maang tikka" },
//     { id: 28, name: "Bridal Bangles", price: "$2,200", category: "Bridal", image: "assets/images/products/bridal-bangles.jpg", desc: "Traditional bridal bangles set of 12 with gold and kundan work" },
//     { id: 29, name: "Bridal Waist Belt", price: "$3,400", category: "Bridal", image: "assets/images/products/bridal-waist-belt.jpg", desc: "Traditional kamarbandh for bridal outfit. Gold plated with pearls" },
//     { id: 30, name: "Bridal Nose Ring", price: "$950", category: "Bridal", image: "assets/images/products/bridal-nose-ring.jpg", desc: "Traditional nath (nose ring) for brides. Gold with pearl drops" },
//     { id: 31, name: "Bridal Armlet", price: "$1,800", category: "Bridal", image: "assets/images/products/bridal-armlet.jpg", desc: "Traditional bajuband (armlet) for bridal look. Gold plated" },
//     { id: 32, name: "Bridal Toe Rings", price: "$350", category: "Bridal", image: "assets/images/products/bridal-toe-rings.jpg", desc: "Set of 4 bridal toe rings with meenakari work" },

//     // ========== PLATINUM COLLECTION (4 products) ==========
//     { id: 33, name: "Platinum Wedding Band", price: "$3,500", category: "Platinum", image: "assets/images/products/platinum-wedding-band.jpg", desc: "Classic platinum wedding band. Hypoallergenic and durable. Weight: 6g" },
//     { id: 34, name: "Platinum Diamond Ring", price: "$7,200", category: "Platinum", image: "assets/images/products/platinum-diamond-ring.jpg", desc: "Platinum ring with 0.7 carat diamond. Elegant and timeless" },
//     { id: 35, name: "Platinum Chain", price: "$2,800", category: "Platinum", image: "assets/images/products/platinum-chain.jpg", desc: "Pure platinum chain for men. Weight: 10g. Length: 20 inches" },
//     { id: 36, name: "Platinum Earrings", price: "$4,500", category: "Platinum", image: "assets/images/products/platinum-earrings.jpg", desc: "Platinum stud earrings with small diamonds. Weight: 3g" },
//     { id: 37, name: "Platinum Pendant", price: "$2,200", category: "Platinum", image: "assets/images/products/platinum-pendant.jpg", desc: "Simple platinum pendant on platinum chain" },
//     { id: 38, name: "Platinum Cufflinks", price: "$1,500", category: "Platinum", image: "assets/images/products/platinum-cufflinks.jpg", desc: "Luxury platinum cufflinks for formal occasions" },
//     { id: 39, name: "Platinum Bracelet", price: "$3,200", category: "Platinum", image: "assets/images/products/platinum-bracelet.jpg", desc: "Elegant platinum bracelet for women. Weight: 8g" },
//     { id: 40, name: "Platinum Nose Pin", price: "$800", category: "Platinum", image: "assets/images/products/platinum-nose-pin.jpg", desc: "Hypoallergenic platinum nose pin. Perfect for sensitive skin" },

//     // ========== ANTIQUE COLLECTION (4 products) ==========
//     { id: 41, name: "Antique Kundan Set", price: "$7,800", category: "Antique", image: "assets/images/products/antique-kundan.jpg", desc: "Traditional Kundan necklace set with vintage finish. Royal look" },
//     { id: 42, name: "Victorian Gold Locket", price: "$1,200", category: "Antique", image: "assets/images/products/victorian-locket.jpg", desc: "Victorian-style gold locket with intricate engravings" },
//     { id: 43, name: "Antique Jhumkas", price: "$950", category: "Antique", image: "assets/images/products/antique-jhumkas.jpg", desc: "Traditional antique finish jhumkas with temple design" },
//     { id: 44, name: "Antique Pendant", price: "$680", category: "Antique", image: "assets/images/products/antique-pendant.jpg", desc: "Vintage-style pendant with oxidized finish" },
//     { id: 45, name: "Antique Bangles", price: "$1,500", category: "Antique", image: "assets/images/products/antique-bangles.jpg", desc: "Set of 2 antique finish bangles with meenakari work" },
//     { id: 46, name: "Antique Necklace", price: "$5,200", category: "Antique", image: "assets/images/products/antique-necklace.jpg", desc: "Long antique necklace with traditional coins" },
//     { id: 47, name: "Antique Ring", price: "$850", category: "Antique", image: "assets/images/products/antique-ring.jpg", desc: "Vintage-style ring with red stone" },
//     { id: 48, name: "Antique Earrings", price: "$720", category: "Antique", image: "assets/images/products/antique-earrings.jpg", desc: "Traditional antique earrings with pearl drops" },

//     // ========== KIDS COLLECTION (4 products) ==========
//     { id: 49, name: "Kids Gold Pendant", price: "$450", category: "Kids", image: "assets/images/products/kids-pendant.jpg", desc: "Cute elephant-shaped gold pendant for children. Lightweight and safe. Weight: 2g" },
//     { id: 50, name: "Kids Silver Anklet", price: "$85", category: "Kids", image: "assets/images/products/kids-anklet.jpg", desc: "Tiny silver anklet with bell charms. Perfect for babies and toddlers" },
//     { id: 51, name: "Kids Gold Earrings", price: "$280", category: "Kids", image: "assets/images/products/kids-earrings.jpg", desc: "Small gold stud earrings for kids. Screw back for safety" },
//     { id: 52, name: "Kids Silver Bracelet", price: "$120", category: "Kids", image: "assets/images/products/kids-bracelet.jpg", desc: "Adjustable silver bracelet for children with name engraving option" },
//     { id: 53, name: "Kids Gold Ring", price: "$195", category: "Kids", image: "assets/images/products/kids-ring.jpg", desc: "Tiny gold ring with flower design. Adjustable size" },
//     { id: 54, name: "Kids Silver Pendant", price: "$75", category: "Kids", image: "assets/images/products/kids-pendant-silver.jpg", desc: "Cute star-shaped silver pendant for kids" },
//     { id: 55, name: "Kids Gold Chain", price: "$350", category: "Kids", image: "assets/images/products/kids-chain.jpg", desc: "Lightweight gold chain for children. Weight: 1.5g" },
//     { id: 56, name: "Kids Nose Pin", price: "$65", category: "Kids", image: "assets/images/products/kids-nose-pin.jpg", desc: "Small gold nose pin for traditional occasions" },

//     // ========== MEN'S COLLECTION (4 products) ==========
//     { id: 57, name: "Men's Gold Ring", price: "$1,200", category: "Mens", image: "assets/images/products/mens-ring.png", desc: "Bold men's gold ring with matte finish. 8g 22K gold" },
//     { id: 58, name: "Men's Silver Chain", price: "$250", category: "Mens", image: "assets/images/products/mens-chain.png", desc: "Heavy silver chain for men. Length: 22 inches, weight: 25g" },
//     { id: 59, name: "Men's Gold Kada", price: "$2,800", category: "Mens", image: "assets/images/products/mens-kada.png", desc: "Traditional gold kada for men. Weight: 15g" },
//     { id: 60, name: "Men's Silver Ring", price: "$180", category: "Mens", image: "assets/images/products/mens-silver-ring.png", desc: "Stylish silver ring for men with black onyx stone" },
//     { id: 61, name: "Men's Gold Chain", price: "$3,200", category: "Mens", image: "assets/images/products/mens-gold-chain.png", desc: "Heavy gold chain for men. Weight: 20g. Length: 22 inches" },
//     { id: 62, name: "Men's Silver Bracelet", price: "$150", category: "Mens", image: "assets/images/products/mens-silver-bracelet.png", desc: "Leather and silver bracelet for men" },
//     { id: 63, name: "Men's Platinum Ring", price: "$2,500", category: "Mens", image: "assets/images/products/mens-platinum-ring.png", desc: "Elegant platinum ring for men with diamond accent" },
//     { id: 64, name: "Men's Cufflinks", price: "$220", category: "Mens", image: "assets/images/products/mens-cufflinks.png", desc: "Classic silver cufflinks for formal occasions" }
// ];
